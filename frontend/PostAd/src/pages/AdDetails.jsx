...
const handlePostAdClick = () => {
  ...
  return (
    ...
    <div className="app-container">
      {/* <Navbar onPostAdClick={handlePostAdClick} openLogin={handleOpenLogin} /> */}
    ...
    <div className="ad-main">
      <div className="carousel">
        ...
        <img
          src={`http://localhost:5001/${ad.images[currentImage]}`}
          alt={`Ad ${currentImage}`}
      ...
      <div className="ad-info-right">
        <h2 className="price">{Number(ad.price).toLocaleString()} Rs</h2>
        <h3>{ad.title}</h3>
        <p>{ad.description}</p>
